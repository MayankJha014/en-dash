...
const CreatePosts = () => {
  ...
  const { isLoading, isError, post } = useSelector((state) => state.auth);
            ...
            <div>
              <div>
                <input
                  ...
                  className="bg-gray-100 border  mb-3 border-gray-300  text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                />
                {tags.map((tag, index) => (
                  <span
                    key={index}
                    className="bg-slate-200 m-1 py-1 px-2 rounded-lg"
                  >
                    {tag}
                    <span
